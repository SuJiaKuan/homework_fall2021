...
class RL_Trainer(object):
    ...
    def collect_training_trajectories(
        ...
        # XXX decide whether to load training data or use the current policy to collect more data
        ...
        # XXX collect `batch_size` samples to be used for training
        ...
        if self.log_video:
            ...
            ## XXX look in utils and implement sample_n_trajectories
    ...
    def do_relabel_with_expert(self, expert_policy, paths):
        ...
        # XXX relabel collected obsevations (from our policy) with labels from an expert policy
